...
# %% auto 0
__all__ = ['print', 'sp', 'ssp', 'clis', 'conts', 'get_pane', 'get_panes', 'get_history', 'get_opts', 'OllamaClient', 'get_sage',
           'main']
...
class OllamaClient:
    "Class for Ollama using OpenAI client"
...
conts = {
    ...
    'openai': cos.contents,
    'ollama': cos.contents, # Use the same way to format contents as Cosette for OpenAI
}
