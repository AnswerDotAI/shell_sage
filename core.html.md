...
<a
href="https://github.com/AnswerDotAI/shell_sage/blob/main/shell_sage/core.py#L142"
...
<a
href="https://github.com/AnswerDotAI/shell_sage/blob/main/shell_sage/core.py#L149"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/shell_sage/blob/main/shell_sage/core.py#L170"
target="_blank" style="float:right; font-size:smaller">source</a>
...
I’m a friendly command-line teaching assistant here to help you learn
and master shell commands and system administration. My knowledge is
up-to-date as of April 2024.

What would you like to know or accomplish with your shell today?

<details>

- id: chatcmpl-558
- choices: \[Choice(finish_reason=‘stop’, index=0, logprobs=None,
  message=ChatCompletionMessage(content=“**Hello! I’m ShellSage**‘m a
  friendly command-line teaching assistant here to help you learn and
  master shell commands and system administration. My knowledge is
  up-to-date as of April 2024.would you like to know or accomplish with
  your shell today?“, refusal=None, role=’assistant’, audio=None,
...
- usage: CompletionUsage(completion_tokens=57, prompt_tokens=344,
  total_tokens=401, completion_tokens_details=None,
...
- choices: \[Choice(finish_reason=‘stop’, index=0, logprobs=None,
  ...
  or `bash\nls *\n\n`: \* may include hidden files’, refusal=None,
...
- service_tier: None
- system_fingerprint: fp_ollama
- usage: CompletionUsage(completion_tokens=38, prompt_tokens=191,
  total_tokens=229, completion_tokens_details=None,
  prompt_tokens_details=None)
...
<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace">**I'm ShellSage, your command-line teaching assistant!**
&#10;I'm here to help you learn and master shell commands and system administration. My knowledge is current as of April
<span style="color: #008080; text-decoration-color: #008080; font-weight: bold">2024</span>, so feel free to ask me any questions or seek guidance on Linux or Unix-like systems.
...
<a
href="https://github.com/AnswerDotAI/shell_sage/blob/main/shell_sage/core.py#L208"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/shell_sage/blob/main/shell_sage/core.py#L205"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/shell_sage/blob/main/shell_sage/core.py#L216"
target="_blank" style="float:right; font-size:smaller">source</a>

### main

>  main (query:str<ThequerytosendtotheLLM>, v:<Printversion>='%(prog)s
>            0.0.10', pid:str='current', skip_system:bool=False,
>            history_lines:int=None, s:bool=False, c:bool=False, log:bool=False,
